...
class RecyclerViewAdapter_divider(context: Context, datas: ArrayList<String>) :
    RecyclerView.Adapter<RecyclerViewAdapter_divider.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater!!.inflate(R.layout.we_sub_recyclerview_divider_item, parent, false)
