...
class RecyclerViewAdapter_click(context: Context, datas: ArrayList<String>) :
    RecyclerView.Adapter<RecyclerViewAdapter_click.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater!!.inflate(R.layout.we_sub_recyclerview_click_item, parent, false)
