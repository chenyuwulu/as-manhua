...
class Course_38_RecyclerViewAdapter_header_and_footer(context: Context, datas: ArrayList<String>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (ITEM_TYPE_HEADER == viewType) {
            view = mInflater!!.inflate(R.layout.course_38_header, parent, false)
            vewHolder = HeaderViewHolder(view)
        } else if (ITEM_TYPE_BOTTOM == viewType) {
            view = mInflater!!.inflate(R.layout.course_38_footer, parent, false)
            vewHolder = FooterViewHolder(view)
        } else {
            view = mInflater!!.inflate(R.layout.course_38_recyclerview_divider_item, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        if (holder is HeaderViewHolder) {
            ...
            if (null != mOnItemClickListener) {
                viewHolder.titleTv!!.setOnClickListener {
                    mOnItemClickListener!!.onClick(
                        viewHolder.titleTv,
                        position
                    )
                }
                viewHolder.contenTv!!.setOnClickListener {
                    mOnItemClickListener!!.onClick(
                        viewHolder.contenTv,
                        position
                    )
            ...
            if (null != mOnItemLongClickListener) {
                viewHolder.titleTv!!.setOnLongClickListener {
                    mOnItemLongClickListener!!.onLongClick(
                        viewHolder.titleTv,
                        position
                    )
                }
                viewHolder.contenTv!!.setOnLongClickListener {
                    mOnItemLongClickListener!!.onLongClick(
                        viewHolder.contenTv,
                        position
                    )
