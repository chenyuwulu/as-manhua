...
class Course_38_RecyclerViewAdapter(context: Context, datas: ArrayList<String>) :
    RecyclerView.Adapter<Course_38_RecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater!!.inflate(R.layout.course_38_recyclerview_item, parent, false)
