...
class Course_38_RecyclerViewAdapter_apply(context: Context, datas: ArrayList<String>) :
    RecyclerView.Adapter<Course_38_RecyclerViewAdapter_apply.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = mInflater!!.inflate(R.layout.course_38_recyclerview_divider_item, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        if (null != mOnItemClickListener) {
            ...
            holder.contenTv!!.setOnClickListener {
                mOnItemClickListener!!.onClick(
                    holder.contenTv,
                    position
                )
        ...
        if (null != mOnItemLongClickListener) {
            holder.titleTv!!.setOnLongClickListener {
                mOnItemLongClickListener!!.onLongClick(
                    holder.titleTv,
                    position
                )
            }
            holder.contenTv!!.setOnLongClickListener {
                mOnItemLongClickListener!!.onLongClick(
                    holder.contenTv,
                    position
                )
